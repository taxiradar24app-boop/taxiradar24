...
<h3>Próximas convocatorias</h3>
        ...
        <ModulesGrid>
          <ModuleCard onClick={() => (window.location.href = "/academia/demo/reglamento")}>
            <header>
              <Emoji>📘</Emoji>
                 <h3>Reglamento oficial</h3>
              </header>
              <p>
                 Texto oficial en PDF explicado en lenguaje de Academia,
                  con ejemplos prácticos, preguntas típicas de examen
                  y resumen final.
              </p>
            <Pill>3 bloques accesibles</Pill>
          </ModuleCard>

          <ModuleCard onClick={() => (window.location.href = "/academia/demo/audios")}>
            <header>
              <Emoji>🎧</Emoji>
          ...
          <ModuleCard onClick={() => (window.location.href = "/academia/demo/simulador")}>
            <header>
              <Emoji>🧠</Emoji>
               <h3>Simulador de examen</h3>
              </header>
              <p>
                Responde un mini examen DEMO con preguntas reales de
                convocatorias anteriores.
              </p>
            <Pill>1 simulador DEMO</Pill>
          </ModuleCard>

          <ModuleCard onClick={() => (window.location.href = "/academia/demo/callejero")}>
            <header>
              <Emoji>🗺️</Emoji>
