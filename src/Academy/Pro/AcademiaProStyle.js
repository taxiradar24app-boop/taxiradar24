...
export const TopTitle = styled.span`
  font-size: 0.9rem;
  color: ${({ theme }) => getColor(theme, "colors.greylight", "#dde1e8")};
`;
...
export const GreetingTitle = styled.h1`
  margin: 0;
  font-size: clamp(1.9rem, 2.4vw + 0.8rem, 2.4rem);
  font-weight: 700;
  line-height: 1.1;
  color: ${({ theme }) => getColor(theme, "colors.greylight", "#e8eaf1")};
`;
...
export const ModuleCard = styled.button`
  ...
  &:hover {
    ...
    box-shadow: 0 24px 56px rgba(15, 23, 42, 0.92);
  }
