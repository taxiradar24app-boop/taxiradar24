...
const audioUrl = (key) =>
  `${AUDIO_BASE}?key=${encodeURIComponent(key)}&token=${encodeURIComponent(
    AUDIO_TOKEN
  )}`;
...
const audios = [
  {
    ...
    file: audioUrl("0-curso-oficial-reglamento-taxi-palma.mp3"),
  },
  {
    id: 1,
    title: "1: Artículos 1 al 3 – Introducción, Objeto y Ámbito",
    file: audioUrl(
      "1-articulos-1-al-3-introduccion-reglamento-objeto-obligacion-ambito.mp3"
    ),
  },
  {
    id: 2,
    ...
    file: audioUrl(
      "2-articulos-4-al-9-numero-licencias-aumentos-disminuciones-tasas.mp3"
    ),
  },
  {
    id: 3,
    ...
    file: audioUrl(
      "3-articulos-10-al-15-creacion-otorgamiento-nuevas-licencias.mp3"
    ),
  },
  {
    id: 4,
    ...
    file: audioUrl(
      "4-articulo-16-rescate-licencias-procedimiento-completo.mp3"
    ),
  },
  {
    id: 5,
    ...
    file: audioUrl(
      "5-articulos-17-al-20-listas-conductores-adjudicaciones-transmisiones.mp3"
    ),
  },
  {
    id: 6,
    ...
    file: audioUrl(
      "6-articulos-21-al-25-titulares-requisitos-honorabilidad-altas-bajas-conductores.mp3"
    ),
  },
  {
    id: 7,
    ...
    file: audioUrl(
      "7-articulos-26-al-27-conductores-permiso-municipal-taxista.mp3"
    ),
  },
  {
    id: 8,
    ...
    file: audioUrl(
      "8-articulos-28-al-32-permiso-municipal-taxista-revision-caducidad-suspension.mp3"
    ),
  },
  {
    id: 9,
    ...
    file: audioUrl(
      "9-articulos-33-al-45-vehiculos-senalizacion-revision-antiguedad-sustitucion.mp3"
    ),
  },
  {
    id: 10,
    ...
    file: audioUrl(
      "10-articulo-46-tarifas-oficiales-servicio-taxi-palma.mp3"
    ),
  },
  {
    id: 11,
    title:
      "11: Artículos 47 al 65 – Prestación del Servicio y Zonas Especiales",
    file: audioUrl(
      "11-articulos-47-al-65-prestacion-servicio-turnos-conductores-usuarios-zonas-especiales.mp3"
    ),
  },
  {
    id: 12,
    ...
    file: audioUrl(
      "12-articulos-66-al-68-revocacion-licencias-permiso-municipal-taxista.mp3"
    ),
  },
  {
    id: 13,
    ...
    file: audioUrl(
      "13-articulos-69-al-74-medidas-correctoras-inmovilizaciones-prohibiciones.mp3"
    ),
  },
  {
    id: 14,
    title: "14: Artículos 77 al 81 – Infracciones Muy Graves, Graves y Leves",
    file: audioUrl("14-articulos-77-al-81-infracciones-muy-graves-graves-leves.mp3"),
  },
  {
    id: 15,
    title: "15: Artículo 82 – Régimen Sancionador e Importes",
    file: audioUrl(
      "15-articulo-82-regimen-sancionador-importes-gravedad-infracciones.mp3"
    ),
  },
];
        ...
        <AudioGrid>
          {audios.map((audio) => (
            <AudioCard key={audio.id}>
              ...
              <AudioDescription>Audio oficial del Reglamento Municipal</AudioDescription>
